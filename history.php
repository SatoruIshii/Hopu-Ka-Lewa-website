...
$params = array(
  ...
  'champtable' => array(
    '2013' => array('Kumoniwannalayya','Magic School Bus','','','Prep Squad','Thom Walker &<br/>Laura Gilda'),
    '2012' => array('Kumoniwannalayya','Sippin\' Sallys','Colorado Z Brigade','The Hucking Faoles','Kumoniwannalayya','Benjamin Storey &<br/>Aaron Johnson'),
    ...
    '2001' => array('Sugar Smacks','Swingers & Dumpers','Oregon Fighting Sheep','','Oregon Fighting Sheep','Mike Elhoff &<br/>Don N.'),
    '2000' => array('Sugar Smacks','Swingers & Dumpers','','','ZenDisc','Mondo Chun'),
  ),
  'admintable' => array(
    '2012' => array('Maui','Chris Stevens','Laura Stevens, Vu Le, Don N., July Thomson, Kayleigh Hudson, Michelle Swan, Clay "Dukes" McKell, Scott Cooney'),
    '2011' => array('Hanalei, Kauai','Chris Stevens','Laura Stevens, Vu Le, Don N., July Thomson, Kayleigh Hudson, Michelle Swan, Sean Munnelly'),
    '2010' => array('Hawi, Big Island','Megan Grimshaw & Chris Stevens','Laura Stevens, Vu Le, Bill Voss, Becky Shor, Don N., Curt Riffel'),
