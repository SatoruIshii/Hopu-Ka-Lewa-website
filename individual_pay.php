  ...
  'content' => '
				...
				<section id="individual_pay" class="grid_12">
						...
						<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
							...
							<table>
							<tr><td><input type="hidden" name="on0" value="Hopu Ka Lewa 2012 fees">Hopu Ka Lewa 2012 fees</td></tr><tr><td><select name="os0">
								<option value="Early Bird fee through September 30th">Early Bird fee through September 30th $120.00 USD</option>
